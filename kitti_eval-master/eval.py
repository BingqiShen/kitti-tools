...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    ...
    for i in range(num_dt):
        ...
        dist = math.sqrt(dt_anno["location"][i, 0]**2 + dt_anno["location"][i, 1]**2)
...
def calculate_iou_partly(dt_annos, gt_annos, metric, num_parts=50):
    ...
    for num_part in split_parts:
        ...
        if metric == 0:
            ...
            # print([a["location"] for a in gt_annos_part])
            # print(example_idx)
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    # mAP3d, mAP3d_R40 = do_eval_sbq(gt_annos, dt_annos, current_classes, min_overlaps, compute_aos, PR_detail_dict=PR_detail_dict)
...
def get_official_eval_result_sbq(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    overlap_0_7 = np.array([[0.7, 0.5, 0.5, 0.7,
                             0.5, 0.7], [0.7, 0.5, 0.5, 0.7, 0.5, 0.7],
                            [0.7, 0.5, 0.5, 0.7, 0.5, 0.7]])
    overlap_0_5 = np.array([[0.7, 0.5, 0.5, 0.7,
